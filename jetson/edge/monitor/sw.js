...
self.addEventListener("fetch", (e) => {
  ...
  // Nunca cachear datos en vivo: stream de vídeo, eventos SSE y API. Tampoco los
  // vídeos subidos (`/video/…`): pesan cientos de MB y se piden por Range, que el
  // caché del navegador serviría mal (reproducción rota).
